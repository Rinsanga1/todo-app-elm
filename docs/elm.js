...
{
	if (region.O.E === region.U.E)
	{
		return 'on line ' + region.O.E;
	}
	return 'on lines ' + region.O.E + ' through ' + region.U.E;
}
...
var $author$project$Main$init = {D: 0, z: '', F: 1, g: _List_Nil};
		...
		switch (msg.$) {
			case 0:
				...
				return _Utils_update(
					...
					{z: value});
			case 1:
				var trimmed = $elm$core$String$trim(model.z);
				return $elm$core$String$isEmpty(trimmed) ? model : _Utils_update(
					model,
					{
						z: '',
						F: model.F + 1,
				...
				return _Utils_update(
					model,
					{
						g: A2(
							$elm$core$List$map,
							function (t) {
								return _Utils_eq(t.y, id) ? _Utils_update(
									t,
									{h: !t.h}) : t;
							},
							model.g)
...
var $author$project$Main$matchesFilter = F2(
...
var $author$project$Main$viewFilters = function (current) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				A3($author$project$Main$filterButton, 'All', 0, current),
				A3($author$project$Main$filterButton, 'Active', 1, current),
				A3($author$project$Main$filterButton, 'Completed', 2, current)
			]));
};
var $author$project$Main$ClearCompleted = {$: 5};
var $elm$html$Html$span = _VirtualDom_node('span');
var $author$project$Main$viewFooter = F2(
	function (remaining, anyDone) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							$elm$core$String$fromInt(remaining) + (' item' + (((remaining === 1) ? '' : 's') + ' left')))
						])),
					anyDone ? A2(
					$elm$html$Html$button,
					_List_fromArray(
...
var $author$project$Main$AddTodo = {$: 1};
...
var $author$project$Main$viewInput = function (inputValue) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$placeholder('What needs doing?'),
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$class('btn-add')
					]),
				_List_fromArray(
					[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								_Utils_Tuple2('check-box', true),
								_Utils_Tuple2('checked', todo.h)
							])),
						$elm$html$Html$Events$onClick(
						$author$project$Main$Toggle(todo.y))
					]),
				_List_fromArray(
					[
						todo.h ? $elm$html$Html$text('✓') : $elm$html$Html$text('')
					])),
				A2(
				$elm$html$Html$span,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onClick(
						$author$project$Main$Delete(todo.y))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('✕')
...
var $author$project$Main$viewTodoList = function (todos) {
	return $elm$core$List$isEmpty(todos) ? A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		A2($elm$core$List$map, $author$project$Main$viewTodoItem, todos));
};
var $author$project$Main$view = function (model) {
	var visibleTodos = A2(
		$elm$core$List$filter,
		$author$project$Main$matchesFilter(model.D),
		model.g);
	var remaining = $elm$core$List$length(
		A2(
			$elm$core$List$filter,
			function (t) {
				return !t.h;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Main$viewInput(model.z),
				$author$project$Main$viewFilters(model.D),
				$author$project$Main$viewTodoList(visibleTodos),
				A2($author$project$Main$viewFooter, remaining, anyDone)
			]));
};
